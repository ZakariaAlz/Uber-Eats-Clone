...
const TABLE_HEAD = [
  ...
  { id: 'entreprise', label: "Nom d'entreprise", alignRight: false },
  { id: 'tel', label: 'Téléphone', alignRight: false },
  { id: 'solde', label: 'Doit', alignRight: false },
                ...
                <TableBody>
                  {loading ? (
                    ...
                    filteredUsers
                      ...
                      .map((client) => {
                        const { _id, nom, prenom, email, entreprise, tel, solde} = client;
                        ...
                        return (
                          <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={isItemSelected}>
                            ...
                            <TableCell align="left">{solde} DA</TableCell>
